package com.example.account_service.adapters.in.exception;

import com.example.account_service.application.dto.security.ApiError;
...
public class GlobalExceptionHandler extends RuntimeException {
    ...
    public ResponseEntity<ApiError> handleAccNotActive(HttpServletRequest request, AccountNotActiveException ex) {
